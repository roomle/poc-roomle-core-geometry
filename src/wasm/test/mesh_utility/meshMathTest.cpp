...
TEST_CASE("mesh intersection - negate vector", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            REQUIRE(negate2(Coordinates2{0, 0}) == Coordinates2{0, 0});
        }
        SECTION("1") {
            REQUIRE(negate2(Coordinates2{1, 0}) == Coordinates2{-1, 0});
            REQUIRE(negate2(Coordinates2{0, 1}) == Coordinates2{0, -1});
            REQUIRE(negate2(Coordinates2{1, 1}) == Coordinates2{-1, -1});
        }
    }
    SECTION("3d") {
        SECTION("0") {
...
TEST_CASE("mesh intersection - add vectors", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            REQUIRE(add2(Coordinates2{0, 0}, Coordinates2{0, 0}) == Coordinates2{0, 0});
        }
        SECTION("1") {
            REQUIRE(add2(Coordinates2{1, 0}, Coordinates2{0, 0}) == Coordinates2{1, 0});
            REQUIRE(add2(Coordinates2{0, 1}, Coordinates2{0, 0}) == Coordinates2{0, 1});
            REQUIRE(add2(Coordinates2{0, 0}, Coordinates2{1, 0}) == Coordinates2{1, 0});
            REQUIRE(add2(Coordinates2{0, 0}, Coordinates2{0, 1}) == Coordinates2{0, 1});
        }
        SECTION("sum") {
            REQUIRE(add2(Coordinates2{1, 2}, Coordinates2{1, 2}) == Coordinates2{2, 4});
        }
    }
    SECTION("3d") {
        SECTION("0") {
...
TEST_CASE("mesh intersection - subtract vectors", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            REQUIRE(sub2(Coordinates2{0, 0}, Coordinates2{0, 0}) == Coordinates2{0, 0});
            REQUIRE(sub2(Coordinates2{1, 2}, Coordinates2{1, 2}) == Coordinates2{0, 0});
        }
        SECTION("1") {
            REQUIRE(sub2(Coordinates2{1, 0}, Coordinates2{0, 0}) == Coordinates2{1, 0});
            REQUIRE(sub2(Coordinates2{0, 1}, Coordinates2{0, 0}) == Coordinates2{0, 1});
            REQUIRE(sub2(Coordinates2{0, 0}, Coordinates2{1, 0}) == Coordinates2{-1, 0});
            REQUIRE(sub2(Coordinates2{0, 0}, Coordinates2{0, 1}) == Coordinates2{0, -1});
        }
        SECTION("difference") {
            REQUIRE(sub2(Coordinates2{2, 4}, Coordinates2{1, 2}) == Coordinates2{1, 2});
        }
    }
    SECTION("3d") {
        SECTION("0") {
...
TEST_CASE("mesh intersection - multiply vector with scalar", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            REQUIRE(multiply2scalar(Coordinates2{0, 0}, 0) == Coordinates2{0, 0});
            REQUIRE(multiply2scalar(Coordinates2{1, 2}, 0) == Coordinates2{0, 0});
            REQUIRE(multiply2scalar(Coordinates2{0, 0}, 1) == Coordinates2{0, 0});
        }SECTION("1") {
            REQUIRE(multiply2scalar(Coordinates2{1, 0}, 1) == Coordinates2{1, 0});
            REQUIRE(multiply2scalar(Coordinates2{0, 1}, 1) == Coordinates2{0, 1});
            REQUIRE(multiply2scalar(Coordinates2{1, 1}, 1) == Coordinates2{1, 1});
        }SECTION("multiply") {
            REQUIRE(multiply2scalar(Coordinates2{1, 2}, 1) == Coordinates2{1, 2});
            REQUIRE(multiply2scalar(Coordinates2{1, 2}, 2) == Coordinates2{2, 4});
        }
    }
    SECTION("3d") {
        SECTION("0") {
...
TEST_CASE("mesh intersection - dot product", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            REQUIRE(dot2(Coordinates2{0, 0}, Coordinates2{0, 0}) == 0);
            REQUIRE(dot2(Coordinates2{1, 0}, Coordinates2{0, 1}) == 0);
            REQUIRE(dot2(Coordinates2{0, 1}, Coordinates2{1, 0}) == 0);
        }SECTION("1") {
            REQUIRE(dot2(Coordinates2{1, 0}, Coordinates2{1, 0}) == 1);
            REQUIRE(dot2(Coordinates2{0, 1}, Coordinates2{0, 1}) == 1);
        }SECTION("sum") {
            REQUIRE(dot2(Coordinates2{1, 1}, Coordinates2{1, 1}) == 2);
            REQUIRE(dot2(Coordinates2{1, 2}, Coordinates2{1, 2}) == 5);
        }
    }
    SECTION("3d") {
        SECTION("0") {
...
TEST_CASE("mesh intersection - square length", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            REQUIRE(squareLength2(Coordinates2{0, 0}) == 0);
        }
        SECTION("1") {
            REQUIRE(squareLength2(Coordinates2{1, 0}) == 1);
            REQUIRE(squareLength2(Coordinates2{0, 1}) == 1);
            REQUIRE(squareLength2(Coordinates2{-1, 0}) == 1);
            REQUIRE(squareLength2(Coordinates2{0, -1}) == 1);
        }
        SECTION("square") {
            REQUIRE(squareLength3(Coordinates3{2, 0}) == 4);
            REQUIRE(squareLength3(Coordinates3{0, 2}) == 4);
            REQUIRE(squareLength3(Coordinates3{2, 2}) == 8);
        }
    }
    SECTION("3d") {
        SECTION("0") {
            REQUIRE(squareLength3(Coordinates3{0, 0, 0}) == 0);
        }
        SECTION("1") {
            REQUIRE(squareLength3(Coordinates3{1, 0, 0}) == 1);
            REQUIRE(squareLength3(Coordinates3{0, 1, 0}) == 1);
            REQUIRE(squareLength3(Coordinates3{0, 0, 1}) == 1);
            REQUIRE(squareLength3(Coordinates3{-1, 0, 0}) == 1);
            REQUIRE(squareLength3(Coordinates3{0, -1, 0}) == 1);
            REQUIRE(squareLength3(Coordinates3{0, 0, -1}) == 1);
        }
        SECTION("square") {
            REQUIRE(squareLength3(Coordinates3{2, 0, 0}) == 4);
            REQUIRE(squareLength3(Coordinates3{0, 2, 0}) == 4);
            REQUIRE(squareLength3(Coordinates3{0, 0, 2}) == 4);
            REQUIRE(squareLength3(Coordinates3{1, 2, 3}) == 14);
        }
    }
}
...
TEST_CASE("mesh intersection - length", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            REQUIRE(length2(Coordinates3{0, 0}) == 0);
        }SECTION("1") {
            REQUIRE(length2(Coordinates3{1, 0}) == 1);
            REQUIRE(length2(Coordinates3{0, 1}) == 1);
            REQUIRE(length2(Coordinates3{-1, 0}) == 1);
            REQUIRE(length2(Coordinates3{0, -1}) == 1);
        }SECTION("square") {
            REQUIRE(length2(Coordinates3{2, 0}) == 2);
            REQUIRE(length2(Coordinates3{0, 2}) == 2);
            REQUIRE(length2(Coordinates3{1, 1}) == Approx(std::sqrt(2)).epsilon(0.001f));
            REQUIRE(length2(Coordinates3{1, 2}) == Approx(std::sqrt(5)).epsilon(0.001f));
        }
    }
    SECTION("3d") {
        SECTION("0") {
            REQUIRE(length3(Coordinates3{0, 0, 0}) == 0);
        }SECTION("1") {
            REQUIRE(length3(Coordinates3{1, 0, 0}) == 1);
            REQUIRE(length3(Coordinates3{0, 1, 0}) == 1);
            REQUIRE(length3(Coordinates3{0, 0, 1}) == 1);
            REQUIRE(length3(Coordinates3{-1, 0, 0}) == 1);
            REQUIRE(length3(Coordinates3{0, -1, 0}) == 1);
            REQUIRE(length3(Coordinates3{0, 0, -1}) == 1);
        }SECTION("square") {
            REQUIRE(length3(Coordinates3{2, 0, 0}) == 2);
            REQUIRE(length3(Coordinates3{0, 2, 0}) == 2);
            REQUIRE(length3(Coordinates3{0, 0, 2}) == 2);
            REQUIRE(length3(Coordinates3{1, 1, 0}) == Approx(std::sqrt(2)).epsilon(0.001f));
            REQUIRE(length3(Coordinates3{1, 0, 1}) == Approx(std::sqrt(2)).epsilon(0.001f));
            REQUIRE(length3(Coordinates3{0, 1, 1}) == Approx(std::sqrt(2)).epsilon(0.001f));
            REQUIRE(length3(Coordinates3{1, 2, 3}) == Approx(std::sqrt(14)).epsilon(0.001f));
        }
    }
}
...
TEST_CASE("mesh intersection - normalize", "[mesh intersection]") {
    SECTION("2d") {
        SECTION("0") {
            auto v = normalize2(Coordinates2{0, 0});
            REQUIRE(std::isnan(v[0]));
            REQUIRE(std::isnan(v[1]));
        }
        SECTION("1") {
            REQUIRE(normalize2(Coordinates2{1, 0}) == Coordinates2{1, 0});
            REQUIRE(normalize2(Coordinates2{0, 1}) == Coordinates2{0, 1});
            REQUIRE(normalize2(Coordinates2{-1, 0}) == Coordinates2{-1, 0});
            REQUIRE(normalize2(Coordinates2{0, -1}) == Coordinates2{0, -1});
            REQUIRE(normalize2(Coordinates2{2, 0}) == Coordinates2{1, 0});
            REQUIRE(normalize2(Coordinates2{0, 2}) == Coordinates2{0, 1});
            REQUIRE(normalize2(Coordinates2{-2, 0}) == Coordinates2{-1, 0});
            REQUIRE(normalize2(Coordinates2{0, -2}) == Coordinates2{0, -1});
        }
        SECTION("normalize") {
            REQUIRE(normalize2(Coordinates3{1, 1}) == Coordinates2{1.0f/std::sqrt(2.0f), 1.0f/std::sqrt(2.0f)});
            REQUIRE(normalize2(Coordinates3{-1, -1}) == Coordinates2{-1.0f/std::sqrt(2.0f),-1.0f/std::sqrt(2.0f)});
        }
    }
    SECTION("3d") {
        SECTION("0") {
            auto v = normalize3(Coordinates3{0, 0, 0});
            REQUIRE(std::isnan(v[0]));
            REQUIRE(std::isnan(v[1]));
            REQUIRE(std::isnan(v[2]));
        }
        SECTION("1") {
            REQUIRE(normalize3(Coordinates3{1, 0, 0}) == Coordinates3{1, 0, 0});
            REQUIRE(normalize3(Coordinates3{0, 1, 0}) == Coordinates3{0, 1, 0});
            REQUIRE(normalize3(Coordinates3{0, 0, 1}) == Coordinates3{0, 0, 1});
            REQUIRE(normalize3(Coordinates3{-1, 0, 0}) == Coordinates3{-1, 0, 0});
            REQUIRE(normalize3(Coordinates3{0, -1, 0}) == Coordinates3{0, -1, 0});
            REQUIRE(normalize3(Coordinates3{0, 0, -1}) == Coordinates3{0, 0, -1});
            REQUIRE(normalize3(Coordinates3{2, 0, 0}) == Coordinates3{1, 0, 0});
            REQUIRE(normalize3(Coordinates3{0, 2, 0}) == Coordinates3{0, 1, 0});
            REQUIRE(normalize3(Coordinates3{0, 0, 2}) == Coordinates3{0, 0, 1});
            REQUIRE(normalize3(Coordinates3{-2, 0, 0}) == Coordinates3{-1, 0, 0});
            REQUIRE(normalize3(Coordinates3{0, -2, 0}) == Coordinates3{0, -1, 0});
            REQUIRE(normalize3(Coordinates3{0, 0, -2}) == Coordinates3{0, 0, -1});
        }
        SECTION("normalize") {
            REQUIRE(normalize3(Coordinates3{1, 1, 0}) == Coordinates3{1.0f/std::sqrt(2.0f), 1.0f/std::sqrt(2.0f), 0});
            REQUIRE(normalize3(Coordinates3{1, 0, 1}) == Coordinates3{1.0f/std::sqrt(2.0f), 0, 1.0f/std::sqrt(2.0f)});
            REQUIRE(normalize3(Coordinates3{0, 1, 1}) == Coordinates3{0, 1.0f/std::sqrt(2.0f), 1.0f/std::sqrt(2.0f)});
            REQUIRE(normalize3(Coordinates3{-1, -1, 0}) == Coordinates3{-1.0f/std::sqrt(2.0f),-1.0f/std::sqrt(2.0f), 0});
            REQUIRE(normalize3(Coordinates3{-1, 0, -1}) == Coordinates3{-1.0f/std::sqrt(2.0f), 0, -1.0f/std::sqrt(2.0f)});
            REQUIRE(normalize3(Coordinates3{0, -1, -1}) == Coordinates3{0, -1.0f/std::sqrt(2.0f), -1.0f/std::sqrt(2.0f)});
            REQUIRE(normalize3(Coordinates3{1, 1, 1}) == Coordinates3{1.0f/std::sqrt(3.0f), 1.0f/std::sqrt(3.0f), 1.0f/std::sqrt(3.0f)});
            REQUIRE(normalize3(Coordinates3{-1, -1, -1}) == Coordinates3{-1.0f/std::sqrt(3.0f), -1.0f/std::sqrt(3.0f), -1.0f/std::sqrt(3.0f)});
        }
    }
}
