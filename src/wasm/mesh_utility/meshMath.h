...
namespace roomle::mesh {
    ...
    inline Vector2 negate2(const float a[]) {
        return {-a[0], -a[1]};
    }
    ...
    inline Vector2 add2(const float a[], const float b[]) {
    ...
    inline Vector2 sub2(const float a[], const float b[]) {
        return {a[0] - b[0], a[1] - b[1]};
    }
    ...
    inline Vector2 multiply2scalar(const float a[], float s) {
        return {a[0] * s, a[1] * s};
    }
    ...
    inline float squareLength3(const float v[]) {
        return v[0] * v[0] + v[1] * v[1] + v[2] * v[2];
    }

    inline float squareLength2(const float v[]) {
        return v[0] * v[0] + v[1] * v[1];
    }

    inline float length2(const float v[]) {
        return std::sqrt(squareLength2(v));
    }

    inline float length3(const float v[]) {
        return std::sqrt(squareLength3(v));
    }

    inline Vector2 normalize2(const float v[]) {
        auto euclideanLength = length2(v);
        return {v[0] / euclideanLength, v[1] / euclideanLength};
    }

    inline Vector3 normalize3(const float v[]) {
        auto euclideanLength = length3(v);
