...
PolygonIndices roomle::csg::polygonsFromMeshSpecification(CSG &csg, const mesh::MeshDataReference &mesh) {
...
void roomle::csg::meshOperation(mesh::Operator op, const mesh::MeshDataReference &meshA, const mesh::MeshDataReference &meshB, mesh::MeshDataInstance &resultMesh) {
    CSG csg;
    PolygonIndices resultPolygons = meshOperation(csg, op, meshA, meshB);
    polygonsToMesh(csg, &resultPolygons, resultMesh);
}

PolygonIndices roomle::csg::meshOperation(
        CSG &csg,
